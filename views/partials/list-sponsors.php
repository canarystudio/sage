<?php
/**
 * Categorised Sponsor List
 *
 * This displays all of the sponsors in their categories.
 * Ordering of sponsorshop categories can be handled by plugin.
 *
 *
 */
...
<h5 class="sponsor-category-title">
  <?php echo $cat->name; ?>
</h5>
