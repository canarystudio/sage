<div class="row">
  <div class="col-sm-3 mb-1 mb-sm-0 pr-sm-2">
    <div><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'thumbnail', array( 'class' => 'img-fluid' ) ); ?></a></div>
  </div>
  <div class="col-sm-9 exhibitor-item-content">
    ...
    <p>
      ...
      <?php if( get_field('booth_number') ): ?><br>Booth Number: <?php the_field('booth_number'); ?><?php endif; ?>
